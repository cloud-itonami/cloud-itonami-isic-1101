# Business Model: Plant Operations Coordination — Spirits Distilling
...
## Classification
- Repository: `cloud-itonami-isic-1101` ([github.com/cloud-itonami/cloud-itonami-isic-1101](https://github.com/cloud-itonami/cloud-itonami-isic-1101))
- ISIC Rev.5: `1101` — Plant Operations Coordination — Spirits Distilling
- Domain: `:beverage/spirits-distilling`
- Social impact: :product-integrity :regulatory-compliance :supply-chain-traceability
- Actor: `:spirits-distilling-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :beverage/spirits-distilling — who wants
...
Capability stack (required): :identity :forms :dmn :bpmn :audit-ledger :cae. Optional: :optimization :telemetry.
...
One managed tenant (:beverage/spirits-distilling):
...
- Do not bypass the `:spirits-distilling-governor` for production decisions.
